  ...
  $.app.menu = {
    ...
    manualScroller: {
      ...
      updateHeight: function(){
        if( ($body.data('menu') == '' || $body.data('menu') == 'vertical-overlay-menu' ) && $('.main-menu').hasClass('menu-fixed')){
    ...
    change: function(defMenu) {
      ...
      if(menuType === '' || menuType === 'vertical-compact-menu' || menuType === 'vertical-content-menu'){
      ...
      ********************************************/
      ...
      if(menuType === '' || menuType === 'vertical-overlay-menu' || menuType === 'vertical-content-menu'){
    ...
    transit: function(callback1, callback2) {
      ...
      if($body.hasClass('vertical-layout')){
        if($body.hasClass('menu-open') || $body.hasClass(' ')){
          $('.menu-toggle').addClass('is-active');

          // Show menu header search when menu is normally visible
          if( $body.data('menu') === '' || $body.data('menu') === 'vertical-content-menu'){
            if($('.main-menu-header')){
    ...
    expand: function() {
      if (this.expanded === false) {
        this.transit(function() {
          ...
          if( $body.data('menu') == '' && $('.main-menu').hasClass('menu-fixed') ){
            $('.main-menu-content').css('height', $(window).height() - $('.header-navbar').height() - $('.main-menu-header').outerHeight() - $('.main-menu-footer').outerHeight() );
            // this.manualScroller.update();
          }
    ...
    toOverlayMenu: function(screen){
      ...
      if(screen == 'sm' || screen == 'xs'){
        if($body.hasClass(menu)){
          $body.removeClass(menu).addClass('');
        }
    ...
    changeMenu: function(screen){
      ...
      if(screen == 'sm' || screen == 'xs'){
        ...
        // Change body classes
        $body.removeClass($body.data('menu')).addClass('vertical-layout  fixed-navbar');
    ...
    reset: function() {
      ...
      this.collapsed = false;
      this.hidden    = false;
      $body.removeClass('menu-hide menu-open menu-collapsed ');
    },
  };
